...
async def predict(item: Item):
    ...
    def provide_advice(pred):
        if pred == 0:
            return "Low risk of pregnancy complication. Continue to get good prenatal care."
        elif pred == 1:
            return "High risk of pregnancy complication. Consult a doctor immediately for further treatment."
